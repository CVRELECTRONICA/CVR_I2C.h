...
void I2C_Init()
{
  TRISBbits.RB1 = 0; TRISBbits.RB0 = 0; PORTBbits.RB1 = 1; PORTBbits.RB0 = 1;
}

void I2C_start(){
    PORTBbits.RB0 = 1; PORTBbits.RB1 = 0;_delay((unsigned long)((26)*(48000000/4000000.0)));PORTBbits.RB1 = 1;_delay((unsigned long)((26)*(48000000/4000000.0)));
}
unsigned char I2C_sendAdress(int byte,char wr){
    byte = byte<<1;
    if(wr == 0){
    ...
    for(int i=0; i<8; i++){
        PORTBbits.RB0 = 0;
        _delay((unsigned long)((26)*(48000000/4000000.0)));
        if((byte & 0x80)==0){
            PORTBbits.RB1 = 0;
        }else{
            PORTBbits.RB1 = 1;
...
void I2C_Stop()
{
 PORTBbits.RB1 = 0;_delay((unsigned long)((26)*(48000000/4000000.0))); PORTBbits.RB0 = 1;_delay((unsigned long)((26)*(48000000/4000000.0)));PORTBbits.RB1 = 1;_delay((unsigned long)((26)*(48000000/4000000.0)));
}
# 79 "i2c.c" 2



void i2c_write(char adress, char val);
void i2c_read(char adress);
